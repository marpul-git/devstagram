...
<!-- En este layouts ira el contenido que compartiran todas las paginas -->
...
<body class="bg-gray-100">
   <header class="p-5 border-b bg-white shadow">
    ...
    <a href="{{ route('home')}}" class="text-3xl font-black">
        ...
        @endauth
        <!-- Si el usuario no está autenticado muestra los enlaces -->
        @guest
         <nav class="flex gap-2 items-center" >
   ...
   <!-- En el main se ira mostrando el contenido de cada vista-->
